export const renderCategories = function renderCategories(categories) {
    let stringHTML = "";
    stringHTML += "                <thead>";
    stringHTML += "                    <tr>";
    stringHTML += "                       <th>Id</th>";
    ...
    for (let item of categories) {
        ...
        stringHTML += "<td><img class\"img_row\" src=\"" + item.imageUrl + "\"></td>";
        stringHTML += "<td>" + item.name + "</td>";
        stringHTML += "<td>";
        stringHTML += "<div class=\"btn btnViewEdit btn-info btn-sm float-right\" data-type=\"categories\" data-id=" + item.id + " >";
        ...
        stringHTML += "</div>";
        stringHTML += "<div class=\"btn btnViewEdit btn-primary btn-sm float-right\" data-type=\"categories\" data-id=" + item.id + ">";
        ...
        stringHTML += "</div>";
        stringHTML += "<div class=\"btn btn-danger btn-sm float-right\" data-type=\"categories\" data-id=" + item.id + " >";
